...
Call is [rejected](https://www.twilio.com/docs/voice/twiml/reject)<br>Caller hears a standard not-in-service message|__from__ exists in __graylist__ and either the count of unanswered challenge questions or the count of incorrectly answered challenge questions is greater than or equal to 3
